<template>
  <div class="vacancies-container">
    <div class="header-row">
      ...
      <h1 class="title">Отклоненные отклики</h1>
    </div>
    ...
    <div class="table-container">
      <div class="table-header">
        ...
        <div class="cell date-column">
          <div class="column-header sortable" @click="toggleSort('updatedAt')">
            <span style="margin-right: 0.3rem;">Дата отклонения</span>
      ...
      <div v-if="!isLoading && !vacancies.length && !errorMessage" class="empty-table-message">
        Список отклоненных откликов пуст.
      </div>
    ...
    <div v-if="selectedVacancy" class="modal-overlay" @click.self="closeModal">
      <div class="modal">
        ...
        <div class="vacancy-details-section">
          ...
          <p><strong>Дата отклонения:</strong> {{ formatDate(selectedVacancy.updatedAt) || 'Не указана' }}</p>
        </div>
...
export default {
  ...
  methods: {
    ...
    async loadVacancies() {
      ...
      const conditions = [{ var: 'status', operator: 'eq', value: 'rejected' }];
